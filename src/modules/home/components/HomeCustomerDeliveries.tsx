...
// Curated highlights without loading the full gallery dataset.
const DELIVERY_PHOTOS = [
  {
    imagePath: "/entregas-media/mkt-f70fefc7",
    crop: [0.036754, 0.150789, 0.571429, 0.321429],
  },
  {
    imagePath: "/entregas-media/instagram/instagram-43c91a37b90fb585124bab7e",
    crop: [0.069052, 0.15602, 0.571429, 0.321429],
  },
  {
    imagePath: "/entregas-media/mkt-ed106e87",
    crop: [0.428571, 0.191309, 0.571429, 0.321429],
  },
] as const;
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-[28px] border border-[#23747C]/15 bg-[#EFF6F1] px-5 py-7 sm:px-9 sm:py-10 lg:grid lg:grid-cols-[1fr_1fr] lg:items-center lg:gap-10 lg:px-12">
        ...
        >
          {DELIVERY_PHOTOS.map(({ imagePath, crop }, index) => (
            <div
              key={imagePath}
            ...
            >
              <div className="relative aspect-square overflow-hidden rounded-xl bg-[#DFEAE5]">
                <img
                  src={`${imagePath}-320.webp`}
                  srcSet={`${imagePath}-320.webp 320w, ${imagePath}-640.webp 640w`}
