...
| MEAS-001 | P0 | Esteio/Sapucaia/Canoas/São Leopoldo | Criar linha de base recorrente | em andamento | GSC, GA4 e CRM | GBP de 90 dias arquivado; demais canais pendentes |
...
| SLP-001 | P1 | São Leopoldo | Reforçar página para consultas genéricas locais | em andamento | deploy, novo rastreamento e prova local | 341 impressões; posições 25–49 nas principais consultas genéricas; código corrigido em 22/08 |
| CIT-001 | P2 | Esteio/Sapucaia/Canoas/São Leopoldo | Conquistar citações locais legítimas | backlog | lista de parceiros | menções indexáveis e coerentes, sem compra de link artificial |
