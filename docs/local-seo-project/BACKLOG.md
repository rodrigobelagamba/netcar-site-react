...
| CIT-001 | P2 | Esteio/Sapucaia/Canoas/São Leopoldo/Nova Santa Rita/Cachoeirinha/Gravataí | Conquistar citações locais legítimas | backlog | lista de parceiros | menções indexáveis e coerentes, sem compra de link artificial |
...
| GRA-001 | P1 | Gravataí | Reforçar página para consultas de seminovos | em andamento | deploy, novo rastreamento e prova local | 196 impressões e zero clique; `seminovos em Gravataí` tem 61 impressões na posição 24,6 |
