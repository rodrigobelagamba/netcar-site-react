...
| INT-001 | P2 | Regional | Interligar cidades, modelos e estoque | concluído | nenhuma | produção validada em 22/08: seis seleções por página local, quatro mercados nas landings, HTTP 200, canonicals próprios, cliques funcionais e nenhum erro de console |
